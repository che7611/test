...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.grStop_3 = QtWidgets.QGroupBox(self.tab_stop)
        self.grStop_3.setGeometry(QtCore.QRect(10, 100, 811, 91))
        self.grStop_3.setObjectName("grStop_3")
        self.b_checkstop_3 = QtWidgets.QPushButton(self.grStop_3)
        self.b_checkstop_3.setGeometry(QtCore.QRect(630, 50, 81, 24))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        self.b_checkstop_3.setFont(font)
        self.b_checkstop_3.setObjectName("b_checkstop_3")
        self.box_nostop_3 = QtWidgets.QSpinBox(self.grStop_3)
        self.box_nostop_3.setGeometry(QtCore.QRect(660, 16, 58, 22))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.box_nostop_3.setFont(font)
        self.box_nostop_3.setMaximum(500)
        self.box_nostop_3.setProperty("value", 2)
        self.box_nostop_3.setObjectName("box_nostop_3")
        self.box_add_3 = QtWidgets.QSpinBox(self.grStop_3)
        self.box_add_3.setGeometry(QtCore.QRect(355, 16, 49, 22))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.box_add_3.setFont(font)
        self.box_add_3.setMaximum(50)
        self.box_add_3.setProperty("value", 0)
        self.box_add_3.setObjectName("box_add_3")
        self.label_16 = QtWidgets.QLabel(self.grStop_3)
        self.label_16.setGeometry(QtCore.QRect(580, 18, 71, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        self.label_16.setFont(font)
        self.label_16.setObjectName("label_16")
        self.label_17 = QtWidgets.QLabel(self.grStop_3)
        self.label_17.setGeometry(QtCore.QRect(274, 17, 71, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        self.label_17.setFont(font)
        self.label_17.setObjectName("label_17")
        self.label_18 = QtWidgets.QLabel(self.grStop_3)
        self.label_18.setGeometry(QtCore.QRect(430, 17, 80, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        self.label_18.setFont(font)
        self.label_18.setObjectName("label_18")
        self.box_diff_3 = QtWidgets.QSpinBox(self.grStop_3)
        self.box_diff_3.setGeometry(QtCore.QRect(510, 15, 54, 24))
        font = QtGui.QFont()
        font.setFamily("方正姚体")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.box_diff_3.setFont(font)
        self.box_diff_3.setMaximum(500)
        self.box_diff_3.setProperty("value", 50)
        self.box_diff_3.setObjectName("box_diff_3")
        self.rStop1_3 = QtWidgets.QRadioButton(self.grStop_3)
        self.rStop1_3.setGeometry(QtCore.QRect(12, 23, 83, 16))
        self.rStop1_3.setChecked(True)
        self.rStop1_3.setObjectName("rStop1_3")
        self.rStop2_3 = QtWidgets.QRadioButton(self.grStop_3)
        self.rStop2_3.setGeometry(QtCore.QRect(11, 43, 101, 16))
        self.rStop2_3.setObjectName("rStop2_3")
        self.rStop3_3 = QtWidgets.QRadioButton(self.grStop_3)
        self.rStop3_3.setGeometry(QtCore.QRect(11, 65, 89, 16))
        self.rStop3_3.setObjectName("rStop3_3")
        self.txt1_3 = QtWidgets.QLineEdit(self.grStop_3)
        self.txt1_3.setGeometry(QtCore.QRect(119, 24, 101, 16))
        self.txt1_3.setStyleSheet("")
        self.txt1_3.setText("")
        self.txt1_3.setReadOnly(True)
        self.txt1_3.setObjectName("txt1_3")
        self.txt2_3 = QtWidgets.QLineEdit(self.grStop_3)
        self.txt2_3.setGeometry(QtCore.QRect(120, 44, 101, 16))
        self.txt2_3.setReadOnly(True)
        self.txt2_3.setObjectName("txt2_3")
        self.txt3_3 = QtWidgets.QLineEdit(self.grStop_3)
        self.txt3_3.setGeometry(QtCore.QRect(120, 65, 101, 16))
        self.txt3_3.setReadOnly(True)
        self.txt3_3.setObjectName("txt3_3")
        self.b_gostop_3 = QtWidgets.QPushButton(self.grStop_3)
        self.b_gostop_3.setGeometry(QtCore.QRect(490, 50, 81, 24))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        self.b_gostop_3.setFont(font)
        self.b_gostop_3.setObjectName("b_gostop_3")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.grStop_3.setTitle(_translate("MainWindow", "止损选项"))
        self.b_checkstop_3.setText(_translate("MainWindow", "逐单止损 "))
        self.label_16.setText(_translate("MainWindow", "不止损单 ："))
        self.label_17.setText(_translate("MainWindow", "追加点位：  "))
        self.label_18.setText(_translate("MainWindow", "止损点位："))
        self.rStop1_3.setText(_translate("MainWindow", "参考开仓价"))
        self.rStop2_3.setText(_translate("MainWindow", "参考会话成本 "))
        self.rStop3_3.setText(_translate("MainWindow", "参考总成本 "))
        self.b_gostop_3.setText(_translate("MainWindow", "止  损 "))
