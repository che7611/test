...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.t_his.setGeometry(QtCore.QRect(10, 230, 1161, 611))
        ...
        self.box_nostop.setGeometry(QtCore.QRect(733, 16, 58, 22))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.box_add.setGeometry(QtCore.QRect(428, 16, 49, 22))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_5.setGeometry(QtCore.QRect(653, 18, 71, 19))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(347, 17, 71, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        ...
        self.label_4.setGeometry(QtCore.QRect(503, 17, 80, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        ...
        self.box_diff.setGeometry(QtCore.QRect(583, 15, 54, 24))
        font = QtGui.QFont()
        font.setFamily("方正姚体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.b_delAll.setGeometry(QtCore.QRect(330, 210, 131, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.b_delStopB.setGeometry(QtCore.QRect(470, 210, 181, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.b_delStopS.setGeometry(QtCore.QRect(660, 210, 161, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.b_delStop.setGeometry(QtCore.QRect(840, 210, 151, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.b_test.setGeometry(QtCore.QRect(1010, 210, 71, 31))
        self.b_test.setObjectName("b_test")
        self.b_test1 = QtWidgets.QPushButton(self.centralwidget)
        self.b_test1.setGeometry(QtCore.QRect(1100, 210, 71, 31))
