...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1104, 886)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.b_autostop = QtWidgets.QPushButton(self.centralwidget)
        self.b_autostop.setGeometry(QtCore.QRect(960, 130, 101, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        self.b_autostop.setFont(font)
        self.b_autostop.setObjectName("b_autostop")
        self.t_his = QtWidgets.QTabWidget(self.centralwidget)
        self.t_his.setGeometry(QtCore.QRect(10, 230, 1081, 601))
        ...
        self.box_product = QtWidgets.QComboBox(self.centralwidget)
        self.box_product.setGeometry(QtCore.QRect(390, 10, 141, 21))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_2.setGeometry(QtCore.QRect(540, 10, 67, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.box_month = QtWidgets.QComboBox(self.centralwidget)
        self.box_month.setGeometry(QtCore.QRect(620, 10, 151, 23))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.box_add = QtWidgets.QSpinBox(self.centralwidget)
        self.box_add.setGeometry(QtCore.QRect(960, 10, 71, 22))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_3.setGeometry(QtCore.QRect(880, 10, 81, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.box_diff = QtWidgets.QSpinBox(self.centralwidget)
        self.box_diff.setGeometry(QtCore.QRect(960, 40, 71, 22))
        font = QtGui.QFont()
        font.setFamily("方正姚体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_4.setGeometry(QtCore.QRect(880, 40, 81, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.box_nostop = QtWidgets.QSpinBox(self.centralwidget)
        self.box_nostop.setGeometry(QtCore.QRect(960, 70, 71, 22))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_5.setGeometry(QtCore.QRect(880, 70, 81, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 20, 281, 161))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.box_qty = QtWidgets.QSpinBox(self.centralwidget)
        self.box_qty.setGeometry(QtCore.QRect(550, 40, 51, 22))
        font = QtGui.QFont()
        font.setFamily("方正姚体")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_9.setGeometry(QtCore.QRect(490, 40, 51, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.b_buy = QtWidgets.QPushButton(self.centralwidget)
        self.b_buy.setGeometry(QtCore.QRect(610, 40, 101, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        self.b_buy.setFont(font)
        self.b_buy.setObjectName("b_buy")
        self.b_sell = QtWidgets.QPushButton(self.centralwidget)
        self.b_sell.setGeometry(QtCore.QRect(720, 40, 101, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        self.b_sell.setFont(font)
        self.b_sell.setObjectName("b_sell")
        self.gr_stop = QtWidgets.QGroupBox(self.centralwidget)
        self.gr_stop.setGeometry(QtCore.QRect(320, 80, 441, 101))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.box_stop_price.setProperty("value", 29500)
        ...
        self.b_stopsell.setGeometry(QtCore.QRect(320, 60, 101, 30))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.b_stopbuy.setGeometry(QtCore.QRect(200, 60, 101, 30))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.c_t1 = QtWidgets.QCheckBox(self.centralwidget)
        self.c_t1.setGeometry(QtCore.QRect(790, 10, 71, 16))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.b_delStop.setGeometry(QtCore.QRect(910, 210, 151, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.box_time = QtWidgets.QSpinBox(self.centralwidget)
        self.box_time.setGeometry(QtCore.QRect(960, 100, 71, 22))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.box_time.setFont(font)
        self.box_time.setMinimum(5)
        self.box_time.setMaximum(10000)
        self.box_time.setSingleStep(5)
        self.box_time.setProperty("value", 10)
        self.box_time.setObjectName("box_time")
        self.label_13 = QtWidgets.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(850, 100, 111, 19))
        font = QtGui.QFont()
        font.setFamily("Adobe Arabic")
        font.setPointSize(12)
        self.label_13.setFont(font)
        self.label_13.setObjectName("label_13")
        self.b_checkstop = QtWidgets.QPushButton(self.centralwidget)
        self.b_checkstop.setGeometry(QtCore.QRect(960, 170, 101, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
        ...
        self.b_pause.setGeometry(QtCore.QRect(850, 130, 101, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b_autostop.setText(_translate("MainWindow", "自动止损 "))
        ...
        self.label_13.setText(_translate("MainWindow", "间隔时间(秒) ："))
